...
public class Welcome_Page extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Soft Bank: A Way for Safe Transaction");
        setExtendedState(this.MAXIMIZED_BOTH);
        getContentPane().setLayout(new java.awt.GridBagLayout());

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Le-robot-Pepper-en-vente-aux-USA-à-partir-de-lété-2015.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(this,"Welcome to Soft Bank: A Way for Safe Transaction!");
